...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    This serializer serializes Customer data including user , related space , first/last name , email, phone , adress, bith date, gender , picture, applied coupons, and last login for this customer.
    """
